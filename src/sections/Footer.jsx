      ...
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400
           sm:max-w-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis quibusdam quasi nobis deserunt atque.</p>
              ...
              <div key={section}>
                ...
                <ul>
                  {section.links.map((link) =>(
                    <li className="mt-3 text-white-400 font-montserrat text-base leading-normal"><a href="">{link.name}</a></li>
                  ))}
                </ul>
              </div>
            ))}
